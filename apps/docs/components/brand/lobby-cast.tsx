...
import { BigMascot } from "./big-mascot";
  ...
  return (
    <>
      {cast.map((member, index) => (
        ...
        >
          <span className="docs-avatar-body">
            <span aria-hidden="true" className="docs-avatar-shadow" />
            <BigMascot className="docs-avatar-mark" kind={member.kind} />
          </span>
          <span className="docs-avatar-tag">{member.name}</span>
        </span>
      ))}
      <div
        className="hb-bubble docs-lobby-bubble"
      ...
      >
        <span className="hb-bubble-name">{cast[chat.speaker].name}</span>
        <Line
          text={
