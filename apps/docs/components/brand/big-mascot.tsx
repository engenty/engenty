 ...
 * lobby on the start page. `FluffyEngenty` renders at a fixed pixel size, so
 * this measures its box and scales the render to it; the lobby scales with
 * the viewport and the cast follows. Falls back to the flat mark by itself.
 */
export function BigMascot({
  className,
  kind,
}: {
  className?: string;
