 ...
 * minting semantics (role, TTLs, cache sizes, signing key, preflight). apps/ai has
 * no package dependency on apps/core, so the factory is replicated here verbatim;
