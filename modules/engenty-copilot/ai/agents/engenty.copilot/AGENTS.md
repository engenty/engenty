...
| `vault_files` | Durable tenant Files (Speicher) for file deliverables — `action`: list / download / url / upload / delete. Separate from run workspace mounts and `/data` module records |
