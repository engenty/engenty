...
- **Is new, asks how to start, or stands in an empty Space** ("wie fangen wir an", "richte mir das ein"): load **getting-started** — the Space's Chief of Staff first, then the one to three apps and the account its work needs, one step per turn. Complete on its own.
