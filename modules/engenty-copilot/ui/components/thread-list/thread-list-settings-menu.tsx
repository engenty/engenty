            ...
            <div className="flex items-center gap-2">
              <Select
                onValueChange={(value) =>
                  list.onPrefsChange((prefs) => ({
                    ...prefs,
                    sortBy: value as ThreadListSortBy,
                  }))
                }
        ...
        <div className="space-y-2 p-2">
          ...
          <CompactFilterSelect
            ...
            onValueChange={(value) =>
              list.onPrefsChange((prefs) => ({
                ...prefs,
                age: value as ThreadListAgeFilter,
              }))
            }
            selectedLabel={
...
function VisibilityFilter(props: {
  ...
  label: string;
  onValueChange: (value: ThreadListArchivedFilter) => void;
  value: ThreadListArchivedFilter;
}) {
  return (
    <div className="grid grid-cols-[5.5rem_minmax(0,1fr)] items-center gap-2">
      <div className="truncate font-medium text-muted-foreground text-xs">
      ...
      <Tabs
        className="justify-self-end"
        onValueChange={(value) =>
          props.onValueChange(value as ThreadListArchivedFilter)
        }
        value={props.value}
      >
