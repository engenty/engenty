...
import type { TaskStatusColor } from "../../src/schema/task-status-colors.js";
import { TASK_STATUS_COLOR_OPTIONS } from "../../src/schema/task-status-colors.js";
...
export interface TaskStatusSettingsSortableRowProps {
  ...
  onRemove: () => void;
  row: TaskStatusDefinition;
  updateRow: (idx: number, patch: Partial<TaskStatusDefinition>) => void;
}
