...
// Legal lifecycle order. `cancelled` is a terminal off-path state and is not
// shown as a step (activeIndex falls to -1, all steps render as future).
const ORDER: InvoiceStatus[] = ["draft", "issued", "sent", "paid"];
...
export function InvoiceStatusStepper({ status }: InvoiceStatusStepperProps) {
