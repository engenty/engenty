...
/**
 * The Spaces whose connected drives this caller may use
 * (PLAN-space-owned-connections.md). A drive belongs to one Space; that Space's
 * members and agents use it, nobody else.
 *
 ...
 *   reaches no account.
 *
 * Throws when memberships cannot be read: answering with the tenant's
 * drives instead would be the leak this rule closes.
 */
