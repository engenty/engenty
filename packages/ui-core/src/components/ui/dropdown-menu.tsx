...
function DropdownMenuTrigger(
  props: MenuPrimitive.Trigger.Props & AsChildProps & { nativeButton?: boolean },
) {
  // Default nativeButton true — most triggers wrap a <button> or Button component.
  // Pass nativeButton={false} explicitly when the trigger is a non-button element.
  const isButton = props.nativeButton !== undefined
    ? props.nativeButton
    : props.asChild
      ? isButtonLike(props.children)
      : true
  return (
...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      ...
      {!asChild ? <ChevronRightIcon className="ml-auto" /> : null}
    </MenuPrimitive.SubmenuTrigger>
  )
}
