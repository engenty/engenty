// The routine's destinations, edited in place — parallel to the triggers editor.
...
export interface RoutineOutcomesEditorProps {
  locale?: string;
  routine: RoutineDto;
}

export function RoutineOutcomesEditor({
  locale = "en",
  routine,
}: RoutineOutcomesEditorProps) {
  ...
  const providersQuery = useOutcomeProvidersQuery(true);
