...
import type { ActionRequestRecord } from "../../hooks/use-action-requests.js";
...
interface ActionRequestHistoryProps {
  emptyLabel: string;
...
export function ActionRequestHistory({
  emptyLabel,
  onSelect,
  requests,
  selectedRunId,
  triggerLabel,
}: ActionRequestHistoryProps) {
