...
- **[Connections](/docs/user/agent-operations/connections)** — linking Google, Microsoft, Slack and others to a space, which account the copilot uses, and setting what agents may do with them.
