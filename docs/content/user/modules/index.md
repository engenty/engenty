---
title: Modules
description: The modules you work in day to day, and the agent operations the copilot can run in each.
---

# Modules

Engenty is made of modules. Each owns a part of your work — the records, the
screens, and a set of **agent operations** the copilot can run against them.

Every module page below lists its operations, marked **Reads** (never changes
anything) or **Writes**. That list is also what the copilot searches: when you
ask for something in your own words, it looks for a matching operation rather
than guessing, which is why you rarely need to know these names.
